                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {loading ? (
                            ...
                            <Link 
                                ...
                                className="flex items-center p-6 bg-slate-50/50 rounded-3xl border border-slate-100 group hover:bg-white hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300"
                            >
