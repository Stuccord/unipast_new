            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
                ...
                <div className="p-12 space-y-10">
                    ...
                    <form onSubmit={handleUpdate} className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        ...
                        <div className="space-y-3">
                            <label className="text-xs font-black text-slate-400 uppercase tracking-widest px-1">Academic Level</label>
                            <select
                                className="w-full bg-slate-50 border-none rounded-2xl py-4 px-6 text-slate-800 font-bold focus:ring-2 focus:ring-[#0D9488]/20 transition-all outline-none appearance-none cursor-pointer"
