...
import { Settings, Bell, Shield, User, Users, Globe, Mail, ChevronRight, Lock, Eye, EyeOff, Loader2, CheckCircle2, AlertCircle } from 'lucide-react'
    ...
    return (
        <div className="space-y-10 max-w-5xl">
            <div className="flex flex-col space-y-2">
                ...
                <p className="text-slate-500 font-medium">Configure your administrative workspace and account preferences.</p>
            </div>
                        ...
                        {activeTab === 'account' && (
                            <div className="space-y-8 animate-in fade-in duration-300">
                                ...
                                <div className="flex justify-end pt-4">
                                    <button 
                                        onClick={handleSave}
                                        className="bg-[#0D9488] hover:bg-teal-700 text-white font-black py-4 px-10 rounded-2xl transition-all shadow-lg shadow-teal-700/20"
                                    >
                                        Save Changes
                                    </button>
                                </div>
