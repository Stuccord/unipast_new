...
part of 'cached_item_model.dart';
...
extension CachedQuestionByIndex on IsarCollection<CachedQuestion> {
  Future<CachedQuestion?> getByQuestionId(String questionId) {
    return getByIndex(r'questionId', [questionId]);
  }

  CachedQuestion? getByQuestionIdSync(String questionId) {
  ...
  Future<List<CachedQuestion?>> getAllByQuestionId(
      List<String> questionIdValues) {
    final values = questionIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'questionId', values);
  }

  List<CachedQuestion?> getAllByQuestionIdSync(List<String> questionIdValues) {
    final values = questionIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByQuestionId(CachedQuestion object) {
    return putByIndex(r'questionId', object);
  }

  Id putByQuestionIdSync(CachedQuestion object, {bool saveLinks = true}) {
    return putByIndexSync(r'questionId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByQuestionId(List<CachedQuestion> objects) {
    return putAllByIndex(r'questionId', objects);
  }

  List<Id> putAllByQuestionIdSync(List<CachedQuestion> objects,
      {bool saveLinks = true}) {
...
extension CachedQuestionQuerySortBy
  ...
  QueryBuilder<CachedQuestion, CachedQuestion, QAfterSortBy> sortByExpiresAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CachedQuestion, CachedQuestion, QAfterSortBy> sortByFilePath() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CachedQuestion, CachedQuestion, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<CachedQuestion, CachedQuestion, QAfterSortBy> sortByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CachedQuestionQuerySortThenBy
  ...
  QueryBuilder<CachedQuestion, CachedQuestion, QAfterSortBy> thenByExpiresAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiresAt', Sort.asc);
    });
  }
  ...
  QueryBuilder<CachedQuestion, CachedQuestion, QAfterSortBy> thenByFilePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'filePath', Sort.asc);
    });
  }
  ...
  QueryBuilder<CachedQuestion, CachedQuestion, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<CachedQuestion, CachedQuestion, QAfterSortBy> thenByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.desc);
    });
  }
...
extension CachedQuestionQueryWhereDistinct
  ...
  QueryBuilder<CachedQuestion, CachedQuestion, QDistinct> distinctByFilePath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CachedQuestion, CachedQuestion, QDistinct> distinctByQuestionId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CachedQuestion, CachedQuestion, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CachedQuestionQueryProperty
  ...
  QueryBuilder<CachedQuestion, DateTime, QQueryOperations>
  ...
  QueryBuilder<CachedQuestion, String, QQueryOperations> filePathProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'filePath');
    });
  }

  QueryBuilder<CachedQuestion, String, QQueryOperations> questionIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'questionId');
    });
  }

  QueryBuilder<CachedQuestion, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
